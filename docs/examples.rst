...
.. literalinclude:: ../examples/synthvoice_simpletest.py
    :caption: examples/synthvoice_simpletest.py
    :linenos:
...
.. literalinclude:: ../examples/synthvoice_midi.py
    :caption: examples/synthvoice_midi.py
    :linenos:
...
.. literalinclude:: ../examples/synthvoice_sample.py
    :caption: examples/synthvoice_sample.py
    :linenos:
...
.. literalinclude:: ../examples/synthvoice_percussive.py
    :caption: examples/synthvoice_percussive.py
    :linenos:
